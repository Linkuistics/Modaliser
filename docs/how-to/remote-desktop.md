...
- **Second F18 press within the arm window** — the host disarms, posts
  an Escape to the viewer (closing the remote modal the first press
...
- Both machines must run Modaliser with the *same* leader keycodes.
